...
title: 'Programming'
date: 2026-04-05
description: 'How programming change my perspective'
tags: ['programming', 'engineer', 'college', 'perspective']
---

## My journey with programming

Deep dive into programming was never come across my mind at all. Actually, i know nothing about programming since my childhood, even though i had created a little education game when i was 6, i didn't know that it's called programming. I just imitate code from youtube videos i watched and made some changes i need. My first app was created using java, and it was a mobile app. And since then, i never interested to continue what i did cause i didn't know what actually i did, the action was just happened and born from curiosity of childhood.

After graduating from highschool and i should decide where and what major i'll join, my parents --especially my father-- encourage me to apply informatics engineering major in one of the best vocation program at college in Bandung. I just say yes and thinking about salary i'll make after the graduation. Yes, i just think about salary not every single thing about logic or layout we know in application. I never know that what i did in my childhood is programming and that's the important major that needed in most fields in this era. I got accepted by the college, and i studied programming there.

As a person who knows nothing about programming, it's kind of overwhelming a little bit at the beginnnig of the semester. I got a little score in few subjects and it forces me to study more then it should, cause i have to catch up on subjects i never really mastered. Time flied, and i was still struggling in the field i got in, until it barely to continue what i started cause i didn't get the point of it.
